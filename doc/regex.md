...
（ScalaにreplaceAllLiterallyメソッドの実装を修正してプルリクエストを送るといいのではないかと思います。）
```scala
  @Test
...
<tfoot>
<tr>
<td colspan="4">Each category of languages, except those marked by a *, is a proper subset of the category directly above it. Any language in each category is generated by a grammar and by an automaton in the category in the same line.</td>
</tr>
</tfoot>
</table>
***
