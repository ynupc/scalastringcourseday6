...
---
<h3>2.6　インデックス</h3>
コレクションのデータ構造はインデックスで操作することを目的とした配列とイテレーションで操作することを目的とした線形リストに大きく分けられます。Stringの実体はCharの配列ですので、イテレーションよりインデックスで操作する方が基本的には望ましいデータ構造です。配列と線形リストについては、<a href="">コラム：配列と線形リスト</a>を参照してください。本節では、Stringのインデックスに関わる処理について説明します。
...
---
<h3>2.7　イテレーション</h3>
コレクションのデータ構造はインデックスで操作することを目的とした配列とイテレーションで操作することを目的とした線形リストに大きく分けられます。Stringの実体はCharの配列ですのでイテレーションよりインデックスによる処理が基本的には望ましいです。SeqやListは線形リストですので、イテレーションによる操作が基本的には望ましいです。配列と線形リストについては、<a href="">コラム：配列と線形リスト</a>を参照してください。
